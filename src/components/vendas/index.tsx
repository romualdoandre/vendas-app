...
export const Vendas: React.FC    = () => {
    ...
    const handleSubmit = (venda: Venda) => {
        ...
        .catch(error =>{
            console.error(error)
            setMessages([{texto: "Ocorreu um erro ao realizar a venda.", tipo: "danger"}])
        })
    }
    ...
    return (<Layout titulo="Venda" mensagens={messages}>
        <VendasForm onSubmit={handleSubmit} onNovaVenda={handleNovaVenda}
